...
13. **Next gate — named-local migration apply:** after separate approval, apply `20260728140500_enable_real_provider_payload_manifest_v2`, which changes only the ProviderPayload manifest CHECK. Run read-only offline preflight and zero-row/protected-table verification before any new cloud window.
...
9. [ ] After separate approval, apply `20260728140500_enable_real_provider_payload_manifest_v2` to the reviewed named-local database and prove offline preflight plus zero-row/protected-table verification.
