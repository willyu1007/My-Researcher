...
2. **In progress — B / RAM:** both custom policies are created and console-verified. Controller is current v1 at repository SHA-256 `ddde63f223f8d1982da124414ff8224aa7a431f56b51af834030b4fb681f4d8c`; runtime is current v2 at repository SHA-256 `1eb7de00aceacc14817b058291eb4f2e85cdbb4c10ea467c91084a75094b1a4b`, with `ListObjects` restricted to `input` / `input/*` and object read/write statements separated. Next create the controller/runtime roles and attach only their corresponding policies.
