...
`/tmp/my-researcher-t153-phase2/live/`. Sources and setup boundaries are defined above. The accounting snapshot through attempt 71 is **1,788,617 reported tokens and five unknown-usage attempts (4, 8, 9, 20, 63)**.
