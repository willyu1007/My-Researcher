...
- [Completed 2026-07-27] prepared and uploaded the two ordered mirror objects. `scifact-mirrors-v1.json` records exact SHA-256, byte sizes, record counts, internal OSS refs, remote lengths/ETags/CRC64-ECMA and local CRC matches. Exact Dataset revision bindings remain intentionally null until the final bundle lineage is selected.
