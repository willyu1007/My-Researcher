...
- Tasks: 151 (planned: 2, in-progress: 1, blocked: 1, done: 1, archived: 146)

## Recently registered or status-changed tasks

| Task | Status | Feature | Dev Docs |
| --- | --- | --- | --- |
| T-148 topic-selection-real-flow-findings | blocked | F-001 | dev-docs/active/topic-selection-real-flow-findings |
| T-151 codex-cli-execution-line | in-progress | F-003 | dev-docs/active/codex-cli-execution-line |
