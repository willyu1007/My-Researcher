...
- [x] CX-05: Promotion support including required risk-bearing Debate, condition suggestions and feedback normalization can execute through Codex; deterministic package/gate/bridge/intake steps join correctly, and human risk acceptance and promotion decisions cannot be authored by a model.
