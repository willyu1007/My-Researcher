...
| T-083 backend-full-suite-environment-isolation | archived | dev-docs/archive/backend-full-suite-environment-isolation |
| T-084 topic-selection-real-e2e-canary | archived | dev-docs/archive/topic-selection-real-e2e-canary |
| T-085 topic-selection-real-e2e-scale-quality | archived | dev-docs/archive/topic-selection-real-e2e-scale-quality |
| T-111 topic-selection-v1a-production-orchestration | archived | dev-docs/archive/topic-selection-v1a-production-orchestration |
| T-116 adaptive-llm-systems-literature-collection-ingestion | archived | dev-docs/archive/adaptive-llm-systems-literature-collection-ingestion |
| T-117 adaptive-llm-systems-readiness-followup | archived | dev-docs/archive/adaptive-llm-systems-readiness-followup |
...
| T-152 codex-app-server-transport | in-progress | dev-docs/active/codex-app-server-transport |
| T-153 topic-selection-codex-product-workflow | planned | dev-docs/active/topic-selection-codex-product-workflow |

## M-001 LLM Research Lifecycle v1

- Status: in-progress
- Description: Establish governance contracts and an executable baseline for LLM-driven research lifecycle workflows.

### F-001 Research Lifecycle Governance Core

- Status: in-progress
- Description: Deliver Stage DAG + Value Gate governance with versioned lifecycle execution for M1-M8 modules.
...
| T-068 topic-selection-backend-decision-chain-acceptance | archived | dev-docs/archive/topic-selection-backend-decision-chain-acceptance |
| T-069 experiment-foundation-design-review-sync | archived | dev-docs/archive/experiment-foundation-design-review-sync |
| T-070 experiment-foundation-dataset-registry-contracts | archived | dev-docs/archive/experiment-foundation-dataset-registry-contracts |
| T-071 experiment-foundation-benchmark-protocol-contracts | archived | dev-docs/archive/experiment-foundation-benchmark-protocol-contracts |
| T-072 experiment-foundation-version-lock-recipe-contracts | archived | dev-docs/archive/experiment-foundation-version-lock-recipe-contracts |
| T-073 experiment-foundation-materialization-adapter-contracts | archived | dev-docs/archive/experiment-foundation-materialization-adapter-contracts |
| T-074 experiment-foundation-result-evidence-sidecar-contracts | archived | dev-docs/archive/experiment-foundation-result-evidence-sidecar-contracts |
| T-075 experiment-foundation-candidate-promotion-contracts | archived | dev-docs/archive/experiment-foundation-candidate-promotion-contracts |
| T-076 experiment-foundation-persistence-api-readiness | archived | dev-docs/archive/experiment-foundation-persistence-api-readiness |
| T-077 experiment-foundation-execution-adapters | archived | dev-docs/archive/experiment-foundation-execution-adapters |
| T-078 experiment-foundation-desktop-workbench | archived | dev-docs/archive/experiment-foundation-desktop-workbench |
| T-079 topic-selection-resource-sampling-policy | archived | dev-docs/archive/topic-selection-resource-sampling-policy |
...
| T-082 topic-selection-paper-project-bridge-downstream-acceptance | archived | dev-docs/archive/topic-selection-paper-project-bridge-downstream-acceptance |
...
| T-088 topic-selection-workflow-runtime-foundation | archived | dev-docs/archive/topic-selection-workflow-runtime-foundation |
| T-089 topic-selection-agent-workflow-review | archived | dev-docs/archive/topic-selection-agent-workflow-review |
| T-090 experiment-foundation-capability-validation | archived | dev-docs/archive/experiment-foundation-capability-validation |
| T-091 paper-implementation-full-landing | archived | dev-docs/archive/paper-implementation-full-landing |
| T-092 paper-implementation-contracts-and-gap-map | archived | dev-docs/archive/paper-implementation-contracts-and-gap-map |
| T-093 paper-implementation-intake-bootstrap | archived | dev-docs/archive/paper-implementation-intake-bootstrap |
| T-094 paper-implementation-motive-evidence-board | archived | dev-docs/archive/paper-implementation-motive-evidence-board |
| T-095 paper-implementation-validation-cycle-planning | archived | dev-docs/archive/paper-implementation-validation-cycle-planning |
| T-096 paper-implementation-workorder-experiment-bridge | archived | dev-docs/archive/paper-implementation-workorder-experiment-bridge |
| T-097 paper-implementation-trace-kernel | archived | dev-docs/archive/paper-implementation-trace-kernel |
| T-098 paper-implementation-result-claim-dossier | archived | dev-docs/archive/paper-implementation-result-claim-dossier |
| T-099 paper-implementation-ai-workflow-harness | archived | dev-docs/archive/paper-implementation-ai-workflow-harness |
| T-100 paper-implementation-desktop-workbench | archived | dev-docs/archive/paper-implementation-desktop-workbench |
| T-101 paper-implementation-contract-evaluation-suite | archived | dev-docs/archive/paper-implementation-contract-evaluation-suite |
| T-102 paper-implementation-v1-hardening | archived | dev-docs/archive/paper-implementation-v1-hardening |
| T-103 experiment-foundation-full-flow-validation-runner | archived | dev-docs/archive/experiment-foundation-full-flow-validation-runner |
| T-104 paper-implementation-live-experiment-adapter | archived | dev-docs/archive/paper-implementation-live-experiment-adapter |
| T-105 paper-implementation-provider-variance-evaluation | archived | dev-docs/archive/paper-implementation-provider-variance-evaluation |
...
| T-107 topic-selection-v1b-workflow-hardening | archived | dev-docs/archive/topic-selection-v1b-workflow-hardening |
| T-108 topic-selection-v1c-workflow-hardening | archived | dev-docs/archive/topic-selection-v1c-workflow-hardening |
| T-109 paper-implementation-v1-runnable-closure | archived | dev-docs/archive/paper-implementation-v1-runnable-closure |
| T-110 experiment-foundation-research-workbench | archived | dev-docs/archive/experiment-foundation-research-workbench |
| T-112 topic-selection-llm-context-cache-runtime | archived | dev-docs/archive/topic-selection-llm-context-cache-runtime |
| T-113 paper-implementation-legacy-authority-cleanup | archived | dev-docs/archive/paper-implementation-legacy-authority-cleanup |
| T-114 paper-implementation-runtime-orchestration-hardening | archived | dev-docs/archive/paper-implementation-runtime-orchestration-hardening |
...
| T-136 scientific-evidence-to-paper-closure | archived | dev-docs/archive/scientific-evidence-to-paper-closure |
| T-137 promoted-topic-to-scientific-dossier-canary | archived | dev-docs/archive/promoted-topic-to-scientific-dossier-canary |
| T-138 topic-to-paper-implementation-semantic-handoff | archived | dev-docs/archive/topic-to-paper-implementation-semantic-handoff |
| T-139 paper-implementation-to-scientific-dossier-semantic-continuation | archived | dev-docs/archive/paper-implementation-to-scientific-dossier-semantic-continuation |
| T-140 topic-semantics-to-core-motive-bootstrap | archived | dev-docs/archive/topic-semantics-to-core-motive-bootstrap |
| T-141 core-motive-to-evidence-board-semantic-handoff | archived | dev-docs/archive/core-motive-to-evidence-board-semantic-handoff |
...
| T-148 topic-selection-real-flow-findings | done | dev-docs/active/topic-selection-real-flow-findings |
...
- Status: in-progress
- Description: Build Electron desktop shell with React/Vite renderer and brand-aligned UI theme system.
