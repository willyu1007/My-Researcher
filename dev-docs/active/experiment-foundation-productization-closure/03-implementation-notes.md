...
- No role, policy attachment, credential, STS session, provider operation, OSS object mutation, capability enable, `CreateJob` or billable execution occurred. Step B remains in progress at role creation.
