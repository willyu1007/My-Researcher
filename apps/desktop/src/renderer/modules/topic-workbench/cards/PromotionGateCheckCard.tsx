...
/**
 * v1c PromotionGateCheck surface — design-spec §379 mandates 6 项 check
 * 逐卡 pass/fail+reason 渲染：trace completeness / boundary consistency /
 * open blocker / accepted risk / recheck impact / narrative consistency。
 *
 * Phase 4 ships the read-only reviewer card surfacing disposition / blockers
 * / warnings / required_actions / loopback_hints / promote_allowed; full 6
 * 项逐卡 grid 在 backend gate-check shape 引入 per-check verdict 时再补。
 */
