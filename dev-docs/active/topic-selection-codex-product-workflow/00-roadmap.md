...
- Current unit: N4 and all six optional v1b support profiles are implemented and qualified. N6 triage preserves actual failed-draft/gate scope; N7 grouping and exhausted-trial synthesis consume original evidence and complete frozen trial bodies. Ordinary v1c support and required four-role risk Debate now have product consumers, frozen scientific/evidence/risk context and exact recovery. Complete their final qualification/default activation, then implement the separate model-candidate/Human-acceptance boundary and record-only feedback consumer. Phase 4 remains in progress.
