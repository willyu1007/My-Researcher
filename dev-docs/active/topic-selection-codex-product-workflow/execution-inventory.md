...
| #22 ordinary N8 assessment | `v1b/n8-topic-value-assessment/system.md` | Prompt v3 covers scoped value reasoning, exact admissible citations, insufficiency and non-advance; was part of the original six; live qualification pending |
| #23 N8 bounded role family | `v1b/n8-bounded-micro-debate/system.md` | Prompt v3 covers four role behaviors, exact admissible citations and preserved objections; qualify each actual role |
