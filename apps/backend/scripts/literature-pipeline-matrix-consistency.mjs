...
//
// Usage:
//   node apps/backend/scripts/literature-pipeline-matrix-consistency.mjs              # check
//   node apps/backend/scripts/literature-pipeline-matrix-consistency.mjs --self-test  # drift-injection negatives
