...
- Current action: prepare a provider escalation from the two RequestIds and exact wire evidence. Do not create sequence 9/10, mutate sequence 8 or run another paid request without a provider-supported correction and a new authorization.
