...
- Phase progress: FIND-018 / TSRF-10 is implemented and focused-verified. Regular N6 now runs one existing 2/1/1 Debate via coordinator or Codex product HTTP; the original gate consumes only its exact reviewed product draft. Completed receipts preserve frozen lineage, role/cost provenance and exact replay; changed attempt inputs conflict. Historical replay, lower-level acceptance/test fixtures and conditional recovery stay available. FIND-027 material-risk promotion support and FIND-028 condition grouping remain.
