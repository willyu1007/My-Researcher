...
- Current unit: N4 generation is implemented and qualified with real non-advance and selectable controlled-availability cases, protected JSON replay and an unchanged N5 Human stop. Continue with the six optional v1b supports in step 2.
