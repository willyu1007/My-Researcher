...
**Remaining:** 3.5 — coordinator N7-feedback recipe wiring the debate runtime into the harness (the N8 debate gate already decides WHEN to debate via `computeTopicSelectionV1bN8DebateTriggers`; 3.5 connects trigger→runDebate→feedback) + full-loop e2e; the deferred compression-facts builder above.
