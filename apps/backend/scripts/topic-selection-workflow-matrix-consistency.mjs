...
//   covered_scenarios     <- maintained scenario registry (bidirectional set equality
...
//
// Usage:
//   node apps/backend/scripts/topic-selection-workflow-matrix-consistency.mjs            # check real files
//   node apps/backend/scripts/topic-selection-workflow-matrix-consistency.mjs --self-test # drift-injection negatives
...
const FILES = {
  ...
  scenarios: 'docs/context/process/topic-selection-scenarios.md',
};
...
export function checkConsistency({ matrix, sources, scenarios }) {
  const issues = [];
