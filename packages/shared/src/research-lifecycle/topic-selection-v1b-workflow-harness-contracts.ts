...
export const TOPIC_SELECTION_V1B_WORKFLOW_HARNESS_SEMANTIC_SUPPORT_SLOTS = [
  {
    ...
    allowed_execution_modes: ['codex_cli', 'codex_assisted', 'human_delegated'],
...
export const TOPIC_SELECTION_V1B_WORKFLOW_HARNESS_NODE_POLICIES = [
  ...
  },
  {
    ...
    route_edges: [
      ...
      {
        route_id: 'RB_N4_EXPAND_EVIDENCE',
        from_node_id: 'topic-selection.v1b.generate-research-slice-options.v1',
        route_signal: 'evidence_expansion_required',
        route_decision: 'expand_evidence',
        next_node_id: 'topic-selection.v1b.create-intake-snapshot.v1',
        handoff_kind: null,
        allowed_gate_statuses: ['admitted'],
      },
      {
        route_id: 'RB_N4_REFRAME_SCOPE',
        from_node_id: 'topic-selection.v1b.generate-research-slice-options.v1',
        route_signal: 'reframe_required',
        route_decision: 'reframe_scope',
        next_node_id: 'topic-selection.v1b.record-research-constraint-profile.v1',
        handoff_kind: null,
        allowed_gate_statuses: ['admitted'],
      },
    ...
    blocker_codes: [
      ...
      'N4_NON_SELECTED_PORTFOLIO_INVALID',
    ...
    loopback_target_codes: ['n4_regenerate_options', 'n4_expand_evidence', 'n4_reframe_scope'],
    replay_hash_components: DEFAULT_REPLAY_HASH_COMPONENTS,
  },
  {
    node_index: 5,
    ...
    blocker_codes: [
      ...
      'selection_payload_unaccepted',
      'selection_option_hash_mismatch',
      'N5_SELECTED_OPTION_NON_SELECTABLE',
    ],
  ...
  },
  {
    ...
    route_edges: [
      ...
      },
      {
        route_id: 'RT_N6_STOP',
        from_node_id: 'topic-selection.v1b.generate-topic-question-candidates.v1',
        route_signal: 'no_viable_question_candidate',
        route_decision: 'stop_v1b_complete',
        next_node_id: null,
        handoff_kind: null,
        allowed_gate_statuses: ['admitted'],
      ...
      {
        route_id: 'RB_N6_EXPAND_EVIDENCE',
        from_node_id: 'topic-selection.v1b.generate-topic-question-candidates.v1',
        route_signal: 'question_evidence_expansion_required',
        route_decision: 'expand_evidence',
        next_node_id: 'topic-selection.v1b.create-intake-snapshot.v1',
        handoff_kind: null,
        allowed_gate_statuses: ['admitted'],
      ...
      {
        route_id: 'RB_N6_REFRAME_SLICE',
        from_node_id: 'topic-selection.v1b.generate-topic-question-candidates.v1',
        route_signal: 'question_scope_reframe_required',
        route_decision: 'reframe_scope',
        next_node_id: 'topic-selection.v1b.select-research-slice.v1',
        handoff_kind: null,
        allowed_gate_statuses: ['admitted'],
