...
- Tasks: 153 (planned: 1, in-progress: 0, blocked: 1, done: 3, archived: 148)

## Recently registered or status-changed tasks

| Task | Status | Feature | Dev Docs |
| --- | --- | --- | --- |
| T-153 topic-selection-codex-product-workflow | done | F-003 | dev-docs/active/topic-selection-codex-product-workflow |
...
| T-152 codex-app-server-transport | archived | F-003 | dev-docs/archive/codex-app-server-transport |
