...
export const TOPIC_SELECTION_CONTEXT_FAMILIES = [
  ...
  'paper_implementation_route_planning',
  'paper_implementation_validation_cycle_planning',
  'paper_implementation_feasibility_planning',
  'paper_implementation_cross_board_synthesis',
  'paper_implementation_evidence_board_curation',
  'paper_implementation_motive_decomposition',
  'paper_implementation_motive_evolution',
