      ...
      messages: [
        {
          ...
          content: [
            'Classify this batch of topic-scoped literature for a role-balanced topic-selection resource sample.',
            'Return one classification for every eligible literature_ref in this batch and copy each literature_ref exactly.',
            'Use roles support, challenge, baseline, context, review, or excluded.',
            'Support is for positive method or enabling evidence; challenge is for risks, attacks, poisoning, failures, or source-verification issues.',
            'Baseline requires evaluation, benchmark, comparison, dataset, leaderboard, or metric semantics.',
            'Context is for foundation/background material. Do not include hidden reasoning; use brief classification_rationale only.',
          ].join(' '),
        },
        {
          role: 'user' as const,
