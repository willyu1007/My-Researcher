...
- PI admission and T2 materialization intentionally reject a first delivery after Cycle closure. The authorized operation therefore remained unexecuted with database writes 0. Reopening the Cycle, deleting the closure, calling repositories below the service fence or changing the old branch would violate D-18/D-23.
