...
- Remaining: after `2026-08-14T16:38:36Z`, verify automatic STS expiration and local residue. Do not retry, reclaim the collection command, poll provider state with the expired credential, invoke close, or patch revision 17. Diagnose only through a separately reviewed read-only boundary before proposing a successor.
