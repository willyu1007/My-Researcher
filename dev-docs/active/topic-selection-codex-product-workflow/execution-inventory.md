...
| #23 N8 bounded role family | `v1b/n8-bounded-micro-debate/system.md` | Prompt v5 covers four role behaviors, exact citations, 0–100 scoring and resolution of assessment defects while retaining actual research blockers; live four-role qualification pending |
