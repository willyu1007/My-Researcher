...
const ARTIFACT_DIR = path.join(REPO_ROOT, 'artifacts/paper-implementation-runtime-stress', RUN_ID);
...
const REQUIRED_RUNTIME_REGRESSION_CASES = [
  ...
  {
    key: 'domain_gate_result_analysis_materialization_closed',
    subtest: 'runtime Domain Gate rejects direct result-analysis Packet materialization after P4',
  },
  {
  ...
  },
  {
    ...
    subtest: 'PaperImplementation result-analysis runtime preserves analysis artifacts but closes packet materialization',
  },
  {
    key: 'domain_gate_result_analysis_route_malformed_and_drift_rejection',
    subtest: 'PaperImplementation result-analysis Domain Gate closes both valid packet requests and rejects malformed payloads',
  },
  {
...
const steps = [
  ...
  },
  {
    ...
    command: 'node',
    args: [
      'apps/backend/scripts/paper-implementation-domain-gate-writer-ownership-check.mjs',
    ],
  },
  {
  ...
  },
  {
    ...
    command: 'node',
    args: [
      'apps/backend/scripts/paper-implementation-live-adapter-ownership-check.mjs',
    ],
  },
  {
  ...
  },
  {
    ...
    command: 'node',
    args: [
      'apps/backend/scripts/paper-implementation-provider-variance-ownership-check.mjs',
    ],
  },
];
