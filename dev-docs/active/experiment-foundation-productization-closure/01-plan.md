...
11. [ ] Escalate the provider rejection with both RequestIds and the exact model/wire evidence. Require a provider-supported correction or confirmed service defect before any new behavior change, successor or paid window; do not create sequence 9/10.
