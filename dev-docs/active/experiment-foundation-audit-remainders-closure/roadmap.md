...
- Delivery state: `in-progress`; Phase 0 complete, product implementation not started.
...
- [ ] Obtain Phase 1 implementation authorization before changing code, configuration, schema or data.
